...
public class Evaluate implements Expression {
    ...
    public Evaluate(String expression) {
        ...
        expressions.push(new org.example.behavioralpatterns.Interpretator.tokens.Number(Integer.parseInt(tokens[0])));
        ...
        for (int i = 1; i < tokens.length; i += 2) {
            ...
            if (operator.equals("+")) {
                expressions.push(new Plus(expressions.pop(), new org.example.behavioralpatterns.Interpretator.tokens.Number(number)));
